...
from api.schemas.consultation import Consultation, ConsultationOut, ConsultationOutSimple
from api.schemas.appointment import AppointmentStatus
from api.schemas.diagnosis import DiagnosisCreate, DiagnosisOut
from api.schemas.treatment import TreatmentOut
from api.db.client import consultations_collection, appointments_collection, treatments_collection, diagnoses_collection
...
async def create_consultation(consultation: Consultation, current_user: dict = Depends(only_specialists)):
    ...
    if diagnosis_input:
        if isinstance(diagnosis_input, dict): # It's a new diagnosis to create
            from api.schemas.diagnosis import DiagnosisCreate
    ...
    if "treatments" in consultation_data and consultation_data["treatments"]:
        ...
        for treatment_data in consultation_data["treatments"]:
            ...
            from api.schemas.treatment import Treatment
